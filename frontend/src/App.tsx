...
function App() {
  ...
  async function sendReportEmail() {
    try {
      ...
      setMessage("📧 Reporte enviado correctamente al administrador");
    } catch (error: any) {
      setMessage(error.message || "Error enviando reporte");
    }
  }
          ...
          <div className="section-header">
            <div>
              ...
              <div className="report-actions">
                ...
                <button 
              type="button" 
              onClick={downloadCashClosingExcel}
            >
